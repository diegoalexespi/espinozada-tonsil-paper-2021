...
dissociation.genes <- read_excel("~/Documents/bar-or_lab/projects/tonsil_project/analysis/supplementary_information/dissociation_genes.xlsx") %>% select('Human ID') %>% na.omit %>% pull("Human ID")
...
BCR_up_only <- read.delim("~/Documents/bar-or_lab/projects/rui_stimulation_project/analysis/gene_list_results/BCR_up_only.txt", header = FALSE, stringsAsFactors = FALSE)[,1]
CD40L_up_only <- read.delim("~/Documents/bar-or_lab/projects/rui_stimulation_project/analysis/gene_list_results/CD40L_up_only.txt", header = FALSE, stringsAsFactors = FALSE)[,1]
costim_up <- read.delim("~/Documents/bar-or_lab/projects/rui_stimulation_project/analysis/gene_list_results/costim_up.txt", header = FALSE, stringsAsFactors = FALSE)[,1]
IL4_up_only <- read.delim("~/Documents/bar-or_lab/projects/rui_stimulation_project/analysis/gene_list_results/IL4_up.txt", header = FALSE, stringsAsFactors = FALSE)[,1]
IL21_up_only <- read.delim("~/Documents/bar-or_lab/projects/rui_stimulation_project/analysis/gene_list_results/IL21_up.txt", header = FALSE, stringsAsFactors = FALSE)[,1]
