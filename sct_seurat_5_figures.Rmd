...
figure_directory <- "/Users/diegoespinoza/Documents/bar-or_lab/projects/tonsil_project/manuscript/figures_20210812/"
...
### Table S3
```{r table s3, eval = TRUE}
write.table(diff_exp_regulons, file = paste0(figure_directory, "TableS3.txt"), sep = "\t", quote = FALSE, row.names = FALSE)
...
dim(assoRes)
write.table(assoRes, file = paste0(figure_directory, "TableS4.txt"), sep = "\t", quote = FALSE, row.names = FALSE)
```
